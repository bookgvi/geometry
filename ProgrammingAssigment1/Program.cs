...
namespace ConsoleApp2
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Calculate two deltas, point3 - is a point of square triangle
            float point3X = point2X;
            float point3Y = point1Y;
            double delta1 = point3X - point1X;
            double delta2 = point3Y - point2Y;
            Console.WriteLine("Coordinates of point 3: (" + point3X + "," + point3Y + ")");

            // Calculate hypotenuse - our distance
            double sumOfdeltas = Math.Pow(delta1, 2) + Math.Pow(delta2, 2);
            double hypotenuse = Math.Sqrt(sumOfdeltas);
